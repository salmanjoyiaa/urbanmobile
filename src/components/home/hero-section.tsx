    ...
    <section className="bg-hero-light pt-4 pb-16 lg:pt-6 lg:pb-24">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-5 lg:px-12">
        ...
        <div className="w-full lg:w-[48%] z-10 flex flex-col items-center lg:items-start text-center lg:text-left">
          <motion.div {...fadeUp(0, reduceMotion ?? false)} className="inline-flex items-center gap-2 rounded-full bg-white/15 backdrop-blur-sm px-4 py-1.5 border border-white/25 mb-6 shadow-sm">
            <span className="text-[11px] lg:text-[12px] font-black text-white tracking-[0.15em] uppercase">
          ...
          <motion.h1
            ...
            className="text-[36px] sm:text-[48px] md:text-[56px] lg:text-[60px] xl:text-[64px] font-black tracking-[-0.04em] leading-[1.05] mb-5 text-white"
          >
            Your Next<br />
            Home,{" "}
            <span className="text-white font-semibold pr-2 tracking-[-0.02em] drop-shadow-sm">Simple</span>
          </motion.h1>

          <motion.p {...fadeUp(0.2, reduceMotion ?? false)} className="text-white/85 max-w-[340px] sm:max-w-lg text-base sm:text-[17px] lg:text-lg leading-relaxed mb-8 font-medium">
          ...
          <motion.div {...fadeUp(0.3, reduceMotion ?? false)} className="flex flex-col sm:flex-row w-full sm:w-auto gap-3 sm:gap-4 mb-8">
            <Link href="/properties" className="w-full sm:w-auto">
              <button className="w-full sm:w-auto min-h-[44px] h-12 bg-white text-primary px-6 py-3 rounded-xl text-[15px] font-bold transition-all hover:bg-white/90 hover:shadow-lg active:scale-[0.98] shadow-md touch-manipulation">
                Browse Rentals
              </button>
            </Link>
            <Link href="/maintenance" className="w-full sm:w-auto">
              <button className="w-full sm:w-auto min-h-[44px] h-12 bg-primary text-primary-foreground px-6 py-3 rounded-xl text-[15px] font-bold border-2 border-transparent transition-all hover:bg-primary/90 hover:shadow-md active:scale-[0.98] touch-manipulation">
                Request Maintenance
              </button>
            </Link>
          </motion.div>
        ...
        >
          <div className="relative w-full max-w-[500px] sm:max-w-[580px] lg:max-w-[680px]">
            ...
            {reduceMotion ? (
              <div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[70%] h-[70%] bg-gradient-to-br from-primary/20 via-primary/10 to-primary/5 rounded-full blur-[80px] -z-10"
                aria-hidden
              />
            ) : (
              <motion.div
            ...
            <motion.div
              className="relative w-full aspect-square max-w-[500px] lg:max-w-[600px] flex items-center justify-center text-white drop-shadow-2xl"
