...
export function MaintenanceRequestForm() {
    ...
    if (isSuccess) {
        return (
            <div className="bg-card dark:bg-card border border-border rounded-2xl p-8 text-center shadow-lg shadow-foreground/5 dark:shadow-background/5">
                <div className="mx-auto w-16 h-16 bg-muted dark:bg-muted/60 rounded-full flex items-center justify-center mb-6">
    ...
    return (
        <div className="bg-card dark:bg-card border border-border rounded-2xl p-8 lg:p-10 shadow-xl shadow-foreground/5 dark:shadow-background/5">
            <div className="mb-8">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        className="h-12 border-border bg-background dark:bg-card rounded-xl"
