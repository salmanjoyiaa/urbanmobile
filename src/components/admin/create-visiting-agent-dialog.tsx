...
export function CreateVisitingAgentDialog() {
    ...
    const onSubmit = async (data: CreateValues) => {
        try {
            const res = await fetch("/api/admin/visiting-team", {
                method: "POST",
            ...
            toast.success("Visiting Team Agent created successfully");
            setOpen(false);
            reset();
            router.refresh();
        } catch (error: any) {
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button>
                    ...
                    Create Visiting Agent
                </Button>
            </DialogTrigger>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Create Visiting Team Agent</DialogTitle>
                    <DialogDescription>
                        This forcefully provisions a new Visiting Agent with an approved status. They will receive an email confirmation.
                    </DialogDescription>
                </DialogHeader>
